    ...
    public partial class Form1 : Form
    {
        ...
        private void Timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (checkBox8.Checked == false)
            {
                ...
                Button1.Enabled = true;
                button3.Enabled = true;
                MessageBox.Show("The terraria.exe Process Was Stoped!", "Izzy's Ultimate Fishing Toolkit v1.40", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void Button5_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                // MC Was Not Started
                MessageBox.Show("Please Start Terraria.", "Izzy's Ultimate Fishing Toolkit v1.40", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        ...
        private void timer13_Tick(object sender, EventArgs e)
        {
            ...
            Process[] pname = Process.GetProcessesByName("terraria");
            if (pname.Length > 0)
            {
