...
namespace WindowsFormsApp2
{
    public partial class Form1 : Form
    {
        ...
        private void Timer1_Tick(object sender, EventArgs e)
        {
            ...
            {
                if (session.Process?.ProcessName == "tmodloder")
                {
        ...
        private void Timer2_Tick(object sender, EventArgs e)
        {
            ...
            if (radioButton2.Checked == true)
            {
                ...
                if (Process.GetProcessesByName("tmodloder").Length > 0)
                {
            ...
            {
                if (myProc.ProcessName == "tmodloder")
                {
                    count = count + 1;
                }
            }
        ...
        private void timer13_Tick(object sender, EventArgs e)
        {
            ...
            Process[] pname = Process.GetProcessesByName("tmodloder");
            if (pname.Length > 0)
            {

                // Get Window Location (Top Left)
                Process[] processes = Process.GetProcessesByName("tmodloder");
